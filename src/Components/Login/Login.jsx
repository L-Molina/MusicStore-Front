...
/**
 * Página de inicio de sesión para MusicStore.
 * Usa hooks de React: useState, useId, useNavigate.
 * Mock de autenticación: cualquier email + contraseña no vacía pasa.
 */
      ...
      <main className="relative z-10 w-full max-w-[420px] login-fade-in">
        ...
        >
          ...
          {error && (
            ...
            >
              <MaterialSymbol className="text-[#ba203f] text-lg shrink-0">error</MaterialSymbol>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            {/* Recordarme */}
            <label htmlFor={remId} className="flex items-center gap-2.5 cursor-pointer select-none">
              <input
                id={remId}
                type="checkbox"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button type="button" className="login-btn-social">
              <MaterialSymbol filled className="text-[18px]">ios</MaterialSymbol>
              Apple
            </button>
          </div>
        </section>
        ...
        <footer className="mt-8 text-center">
          ...
          <p className="mt-6 max-w-xs mx-auto text-[10px] leading-relaxed text-zinc-700">
            ...
            MusicStore es una plataforma profesional de audio.
          </p>
        </footer>
      </main>

      {/* Barra de estado decorativa */}
      <div className="login-status-bar font-mono text-[9px] uppercase tracking-widest text-zinc-600" aria-hidden="true">
